...
public enum WmAdTableInsertMine {
...
//            null),
    ...
    AD_ZONE_LOCATION("ad_zone_location",
            ...
            new String[][] { new String[] {"Homepage", "Home Page For APP"}, new String[] {"Homepage", "Home Page For APP"} }
           )//,
/*    
...
//            null),
    ...
    ADVERTISEMENT("advertisement",
            new String[] { "name#VARCHAR(100)#false", "description#VARCHAR(500)", "advertiser_id#INT#false" },
            null,
            new String[] { "advertiser_id#advertiser#id" }),
    CREATIVE_FORMAT("creative_format",
            new String[] { "format#VARCHAR(15)#false" },
            new String[] { "format#UNIQUE#format" },
            null),
    CREATIVE("creative",
...
//            null),
    ...
    FLIGHT_BUDGET("flight_budget",
            new String[] { "description#VARCHAR(500)", "flight_budget_amount#INT", "start_date#DATE", "end_date#DATE",
                    "campaign_budget_id#INT#false", "budget_duration_id#INT#false", 
                    "pacing_type_id#INT#false", "cost_method_id#INT", 
                    "freq_cap_interval_type_id#INT#false", "cost_price#INT#false" },
            null,
            new String[] { "campaign_budget_id#campaign_budget#id", "budget_duration_id#budget_duration#id",
    ...
    CAMPAIGN("campaign",
            new String[] { "name#VARCHAR(100)#false", "description#VARCHAR(500)", "start_date#DATE", "end_date#DATE",
                    "campaign_type_id#INT#false", "time_zone_id#INT#false", "advertiser_id#INT#false",
                    "campaign_budget_id#INT#false", "cost_method_id#INT#false" },
            null,
            new String[] { "campaign_type_id#campaign_type#id", "advertiser_id#advertiser#id",
    ...
    DEVICE_TARGET("device_target",
            new String[] { "device_make_id#INT#false", "device_model_id#INT#false" },
            new String[] { "device_make_model#UNIQUE#device_make_id,device_model_id" },
            new String[] { "device_make_id#device_make#id", "device_model_id#device_model#id" }),
    USER("user", 
...
*/
  ;
    ...
    private WmAdTableInsertMine(final String name, final String[] cols, final String[][] rows) {
        this.name = name;
        this.cols = cols;
        this.rows = rows;
    }
    ...
    private void addCols(final Table table) {
        ...
        for (final String col : cols) {
            final Column column = new Column(col, null, false, null);
            table.add(column);
        }
    }

    private void addRows(final Table table) {
        if (rows == null) {
            return;
        }
        for (final String[] row : rows) {
        	final Row rowObj = new Row();
